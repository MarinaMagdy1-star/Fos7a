...
<?php include("php-includes/head-tags.php"); ?>
    ...
    <center><h3 class="title">أضف صور مكانك</h3></center>


                                         <div class="col-md-6">
                                        <div class="mb-3">
                                            <br><br>
                                            <label class="formFileMultiple">الصوره الاولي<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <br><br>
                                            <label class="formFileMultiple">الصوره الثانيه<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="formFileMultiple">الصوره الثالثه<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="formFileMultiple">الصوره الرابعه<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="formFileMultiple">الصوره الخامسه<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="d-grid">
                                      <br><br>
                                        <button type="submit" id="submit_images" name="more_images" class="btn btn-primary">ارفع</button>
                                     </div>
                                 </div>
