                ...
                <div class="row mt-5 justify-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-block">
                        <ul class="breadcrumb breadcrumb-muted mb-0 p-0">
                            <li class="breadcrumb-item"><a href="index.php">الصفحه الرئيسيه</a></li>
                            <li class="breadcrumb-item active" aria-current="page">حسابك</li>
                            <li class="breadcrumb-item"><a href="place_information.php">اضافه مكان</a></li>
...
<section>
            <div class="container">
                <a href="place_information.php" class="btn btn-primary">اضافه مكان </a>
                <table class="table">
                    <thead>
                        <tr>
                            <th>#</th>
